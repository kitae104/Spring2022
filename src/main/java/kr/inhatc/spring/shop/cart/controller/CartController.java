package kr.inhatc.spring.shop.cart.controller;
...
import kr.inhatc.spring.shop.cart.service.CartService;
...
public class CartController
{
			...
			BindingResult bindingResult, Principal principal)
	{
		...
		try
		{
			// 화면으로부터 넘어온 장바구니에 담을 상품 저보와 현재 로그인한 회원의 
			//이메일 정보를 이용하여 장바구니에 상품을 담는 로직을 호출
		...
		// 결과 값으로 생성된 장바구니 상품 아이디와 요청이 성공했다는 응답 상태 반환
	...
	{
		// 현재 로그인한 사용자의 이메일 정보를 이용하여 장바구니에 담겨있는 상품 정보를 조회함.
	...
	{
		// 상품 개수를 0개 이하로 업데이트 요청하려할 때 에러 메시지를 담아 반환
		if(count <= 0)
		{
